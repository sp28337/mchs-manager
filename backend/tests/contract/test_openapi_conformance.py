...
def test_the_spec_has_no_operations_for_unimplemented_modules_we_claim_to_serve() -> None:
    ...
    additive = {
        ...
        # LR012+. Спецификация даёт создание версии, публикацию, пробный
        # прогон и чтение ДЕЙСТВУЮЩЕЙ версии, но не список версий правила.
        # Без него работа юриста обрывается посередине: черновик создан,
        # его идентификатор потерян при перезагрузке — см.
        # `ListRuleVersionsQuery`.
        "get /legal-rules/rules/{}/versions",
