...
export const metadata: Metadata = {
  ...
  // (`apple-mobile-web-app-status-bar-style`). Всё, что заявляет цвета
  // верха, из этого приложения выведено — именно такое заявление однажды
  // и сломало смену темы на айфоне (`app/manifest.ts`). Подпись к цвету
  // отношения не имеет и остаётся.
