...
export const metadata: Metadata = {
  ...
  // Ключевые слова поисковики давно не взвешивают, и держатся они здесь
  // перечнем запросов, на которые сервис отвечает, — от общего к частному,
  // а не от частого к редкому.
  keywords: [
