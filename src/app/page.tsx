...
const FAQ: { question: string; answer: string }[] = [
  ...
  },
  {
    ...
    answer:
      ...
      "Для сотрудников ФПС ГПС и вольнонаёмных работников применяются разные нормативные основания — поэтому норму вы выбираете сами, а калькулятор при ней называет пункт приказа и статью, которыми её можно подтвердить.",
  },
  {
...
const STEPS = [
  {
    ...
    text:
      "Ответьте на несколько вопросов: как к вам обращаться, какой у вас караул, когда у него любая известная вам смена " +
    ...
    <>
      ...
      <main className="mx-auto w-full max-w-4xl px-6 pb-16 xl:max-w-6xl 2xl:max-w-7xl">
        ...
        >
          ...
          <div className="grid gap-6 md:grid-cols-2">
            <p className="max-w-prose">
              Для расчёта могут понадобиться сведения о больничных, а иногда — об инвалидности.
        ...
        <div className="flex flex-col gap-10 md:flex-row items-end px-6 py-8 ">
          <div className="mx-auto w-full max-w-4xl space-y-2 text-xs text-ink-muted xl:max-w-5xl">
            ...
            <p className="max-w-prose">
              ...
              что правильно указали норму, караул, дату своей смены и периоды отсутствия.
            </p>
          </div>
