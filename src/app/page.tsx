          ...
          <dl className="grid gap-x-8 gap-y-4 sm:grid-cols-2">
            {[
              ...
              [
                ...
                "Денежное довольствие сотрудников ФПС ГПС: часовая ставка от должностного оклада, полуторный и двойной размер за сверхурочную работу. Действует с 12.08.2024 вместо приказа № 195 — по нему калькулятор и считает деньги.",
                "https://www.garant.ru/products/ipo/prime/doc/409362157/",
              ],
              [
