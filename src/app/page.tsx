...
const SOURCES: [source: string, what: string, href: string][] = [
  ...
  //   " Порядок привлечения сотрудников ФПС ГПС к выполнению служебных обязанностей сверх установленной нормальной продолжительности служебного времени",
...
const FAQ: { question: string; answer: string }[] = [
  ...
  //     "время, но сверхурочной работы не создают.",
  // },
  {
