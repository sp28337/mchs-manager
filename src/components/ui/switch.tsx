...
export function Switch({
   ...
   *
   * Не только строка: в окне дня подпись состоит из клетки — той самой,
   * какой этот вид суток стоит на сетке, — и названия. Клетка помечена
   * `aria-hidden`, поэтому произносится по-прежнему одно название.
   */
  label: ReactNode;
  /**
