  ...
  return (
    <dialog
      ...
      className={cn(
        ...
        // Бумага у окна ПОДНЯТАЯ — та же, что была у плашки внутри него.
        // ---------------------------------------------------------------
        // Прежде окно было листом обычной бумаги, а на нём лежала плашка
        // с вопросами: коробка в коробке — две кромки, два фона и полоска
        // между ними там, где всего-то строка-другая текста. Теперь
        // поднято само окно, а плашки внутри растворяются в нём
        // (`.modal [data-card]` в `globals.css`), оставляя от себя только
        // линовку между строками.
        "lit modal-lift rounded-xl bg-paper-raised p-0 text-ink",
    ...
    >
      ...
      <div
        ...
        className={cn(
          ...
          "min-h-0 flex-auto overflow-y-auto overscroll-contain bg-paper-raised px-5 pt-2 pb-5",
          sheet && "max-sm:px-4",
          bodyClassName,
        )}
      >
