          ...
          <span className="min-w-0 leading-none">
            <span className="block whitespace-nowrap font-display text-black/80 dark:text-ink text-xl font-bold uppercase leading-tight tracking-wide">
              {/* Ниже 400 точек уходит СЛОВО, а цифры остаются.
                  ---------------------------------------------------------
                  Кнопок в шапке четыре, и на телефоне название с ними в
                  строку не влезает: знак ужимается (`min-w-0`) и потому не
                  переносится, а молча уезжает под кнопки — замером на 360
                  точках от «ГРАФИК 1|3» оставалось «ГРАФИК 1», и цифры
                  графика, ради которых половина названия и держится,
                  пропадали первыми.
                  ...
                  порог теперь ровно между 360 (обрезано) и 400 (целиком).
