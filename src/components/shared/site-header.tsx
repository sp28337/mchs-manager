 ...
 * одной причине — значкам блоков. «Калькулятор переработки для пожарных»
 * это две строки, и вместе с пятью значками и кнопкой выгрузки они в
 * телефон не помещаются.
 *
