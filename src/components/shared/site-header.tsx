 ...
 *
 * Четвёртое — кнопки рабочего экрана (`tools`): настройки, расчёт в
 * деньгах и выгрузка профиля в файл. Они ни к какому месту страницы не
 ...
 * пожарных» это две строки, и вместе с тремя кнопками они в телефон не
 * помещаются.
 *
 ...
 * обновить.
 *
 * Порог — `md`: три кнопки с подписями занимают 433 точки, название — ещё
 * двести с небольшим; вдвоём они помещаются начиная с 768. Ниже кнопки
 * сворачиваются в одну (меню), и название возвращается на своё место.
 *
 ...
 * заранее — сперва три кнопки сворачиваются в одну, потом уходит
 * название сайта. Кнопки не жмутся никогда: сжатая кнопка это обрезанная
 * подпись, а не выигранное место.
 *
