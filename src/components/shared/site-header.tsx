...
export function SiteHeader({ tagline, action, className }: SiteHeaderProps) {
  return (
    <header className={cn("fixed w-full border-b border-rule backdrop-blur-md bg-paper-sunken/70 z-100", className)}>
      <div className="mx-auto flex w-full max-w-[112rem] flex-wrap items-center gap-x-6 gap-y-3 px-4 py-3 sm:px-6">
        <Link
          href="/"
