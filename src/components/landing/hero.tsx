...
export function LandingHero({ cta }: { cta: ReactNode }) {
  return (
    ...
    // меньшего.
    <section className="hero-band grid items-center gap-10 pt-24 pb-14 md:min-h-[84lvh] md:grid-cols-2 md:gap-8 md:pt-15 md:pb-0 lg:gap-12">
      {/* Текст поверх плоскости: дальний край месяца уходит под него, и
          порядок слоёв должен быть назван явно. */}
      <div className="relative z-10 space-y-6 max-md:order-2">
