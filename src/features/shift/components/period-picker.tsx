 ...
 *
 * «Учётный период» и «Помесячно». Раньше кварталы стояли отдельной
 * группой «Только для сверки»: приложение знало, сотрудник человек или
 * работник, и по букве приказа сотруднику квартал учётным периодом не
 * является (№ 308 п. 2 оставляет ему полугодие или год). На экране это
 * была пометка на половине пунктов, которую нужно прочитать и понять,
 * прежде чем нажать.
 *
