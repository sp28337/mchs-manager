  ...
  return (
    <>
        ...
        <FadeIn key="calendar">
          <section aria-labelledby="calendar-heading" className="space-y-4 -translate-y-2">
            ...
            <YearView
              ...
              month={month}
              onMonth={setMonth}
              // Нажатие по дню раскрывает кольцо видов вокруг клетки, а
              // повторное нажатие по тому же дню — полное окно: одно и то
              // же место, два шага вглубь. Второй шаг делает сама накладка
              // на дне внутри кольца (`onOpenEditor`), поэтому здесь
      ...
      <DayRing
        ...
        // Полное окно за кольцом: там остальные виды вызова, время смены и
        // часы. Кольцо при этом закрывается — два слоя об одном и том же
        // дне разом только спорили бы друг с другом.
        onOpenEditor={() => {
          setPickedDay(ringDay);
          setRingDay(null);
        }}
      />
