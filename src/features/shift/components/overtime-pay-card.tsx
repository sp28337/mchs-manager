    ...
    <div className="space-y-4">
      <div className="space-y-1.5">
        <div className="flex items-center gap-1.5">
          ...
          {/* Необязательность названа у самого поля, а не только у
              заголовка раздела: пустое поле в анкете человек читает как
              недоделанную работу, если ему не сказать обратное. */}
          <span className="text-[11px] text-ink-faint">необязательно</span>
