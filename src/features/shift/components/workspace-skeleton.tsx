 ...
 * полосы итога, заголовка, панели управления, легенды и сеток — сходятся
 * с рабочим экраном на 390, 768, 1024 и 1440 точках.
 *
    ...
    <MonthGrid
      ...
      renderDay={(day, corners) => (
        ...
        >
          ...
          <div
            className={cn(
              "skeleton-bone flex aspect-square w-full min-w-0 flex-col items-center justify-center rounded-md leading-tight",
