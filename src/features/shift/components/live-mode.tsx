...
export function LiveModeNote() {
  return (
    <>
      Расчёт обрезается живым временем: от вашей первой смены по сегодняшний
      день включительно, а не за весь учётный период. Так и ведут табель — к
      сегодняшнему числу видно, сколько переработки уже набежало. Выключенный
      режим показывает период целиком, то есть норму, которую предстоит
      отработать до его конца.
    </>
  );
}
