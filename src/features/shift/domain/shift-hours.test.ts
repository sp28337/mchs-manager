 ...
 *
 * Числа здесь — не из кода, а с часов: смена с 08:30 идёт до 08:30
...
describe("другое время начала", () => {
  test("начало в 08:00 даёт 16 и 8 при тех же ночных", () => {
    // Ночные от времени начала не зависят, пока он между 06:00 и 22:00:
  ...
  test("начало в полночь оставляет смену в одних сутках", () => {
  ...
  test("начало в 23:00 переносит ночь целиком во вторые сутки", () => {
